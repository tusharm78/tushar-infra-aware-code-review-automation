...
An automated, RAG-driven framework to audit AWS Glue ETL scripts for security, performance, and compliance using Anthropic Claude 3.5 Sonnet via Amazon Bedrock.

Disclaimer: This project is a generalized reference implementation. All names, identifiers, and configurations are illustrative.
...
<img width="1030" height="716" alt="Infra-aware-code-review-automation" src="https://github.com/user-attachments/assets/efb8adb9-7020-49c7-a037-f610f217766c" />
